...
write_source(pathway_source, source_dir, "figure6a_pathway_nodes.tsv")
...
write_source(independent_units, source_dir, "figure6d_independent_genetic_units.tsv")
write_source(tcf_plot, source_dir, "figure6e_tcf7l2_clones.tsv")
