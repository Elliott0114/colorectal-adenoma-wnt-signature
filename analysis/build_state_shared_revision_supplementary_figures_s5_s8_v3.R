...
signature_labels <- c(state_shared_1843 = "Full programme", compact_8 = "Eight-gene candidate")
signature_colours <- c("Full programme" = figure_colours[["grey"]], "Eight-gene candidate" = figure_colours[["adenoma"]])
...
p5d <- ggplot(ffpe_scores, aes(full_delta, compact_delta)) +
  ...
  labs(x = "Full-programme paired difference", y = "Eight-gene paired difference") +
  theme_cb()
