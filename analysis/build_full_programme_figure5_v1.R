...
write_source(model_plot, source_dir, "figure5b_adjusted_rna_atac_models.tsv")
write_source(patient_median, source_dir, "figure5c_patient_medians.tsv")
write_source(atlas_plot, source_dir, "figure5d_atlas_carriers.tsv")
write_source(atlas_base, source_dir, "figure5e_atlas_adjusted_effects.tsv")
write_source(atlas_omission, source_dir, "figure5f_atlas_study_omission.tsv")
